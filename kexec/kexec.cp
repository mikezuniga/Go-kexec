...
// public function to wait for a job to complete.
// It kills the job if the pod fails
func (k *Kexec) WaitForJobComplete(jobName, namespace string) error {
	...
	case v1.PodSucceeded:
		log.Println("Job", jobName, "succeeded!")
	case v1.PodFailed:
		log.Println("Job", jobName, "Failed! Killing the job...")
		err := k.Clientset.Batch().Jobs(namespace).Delete(jobName, nil)
		if err != nil {
			return err
		}
	default:
